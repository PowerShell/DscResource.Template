...
# This must always be after the function definition above.
$script:localizedData = Get-LocalizedData -ResourceName 'CommonResourceHelper' -ScriptRoot $PSScriptRoot
