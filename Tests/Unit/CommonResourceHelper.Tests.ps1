...
InModuleScope 'CommonResourceHelper' {
    ...
    Describe 'CommonResourceHelper\New-InvalidResultException' {
    ...
    Describe 'CommonResourceHelper\New-ObjectNotFoundException' {
        Context 'When calling with Message parameter only' {
            It 'Should throw the correct error' {
                $mockErrorMessage = 'Mocked error'
    ...
    Describe 'CommonResourceHelper\New-InvalidOperationException' {
        Context 'When calling with Message parameter only' {
            It 'Should throw the correct error' {
                $mockErrorMessage = 'Mocked error'
    ...
    Describe 'CommonResourceHelper\New-InvalidArgumentException' {
...
Describe 'CommonResourceHelper\Test-DscParameterState' -Tag TestDscParameterState {
